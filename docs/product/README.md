...
This index covers the standalone Claude Design Desktop product records. Each article distinguishes source evidence, planned behaviour, and unverified work. The documentation site source under `docs/src` is maintained by another lane.
...
| [Release readiness](release-readiness.md) | Windows x64 packaging, unsigned Squirrel.Windows requirements, and evidence |

## Documentation status

These articles document the extraction state. They do not turn planned features into shipped features. The roadmap remains the authoritative checklist for completion claims.
