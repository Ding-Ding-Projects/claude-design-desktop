...
export interface ThreadSummary { id: string; sessionId: string | null; name: string | null; status: string | null; cwd: string | null; }
export interface ThreadSnapshot { thread: ThreadSummary; turns: TurnSnapshot[]; }
export interface TurnSnapshot { id: string; status: string | null; errorMessage: string | null; }
...
export type TurnInputItem = { type: "text"; text: string } | { type: "image"; url: string } | { type: "localImage"; path: string };
