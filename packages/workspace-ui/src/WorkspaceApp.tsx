            ...
            {accounts.map((account) => (
              <li key={account.slotId}>
                <div>
                  ...
                  <span className="muted">{account.email ?? "No email supplied"} · {account.state}{account.plan ? ` · ${account.plan}` : ""}</span>
                </div>
